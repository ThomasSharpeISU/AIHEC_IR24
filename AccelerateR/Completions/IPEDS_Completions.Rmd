---
title: "IPEDS Completions Example"
...
My process is to query the database directly. So you can run the text file thing though, use the excel/csv load chunk.
...
So you can run the text file code. My process is direct SQL as much as possible though.
```{r, eval = TRUE}
